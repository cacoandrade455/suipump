/// Unit tests for suipump::bonding_curve (v8)
///
...
///
/// Run with: `sui move test` from the contracts-v8/ directory.
#[test_only]
module suipump::bonding_curve_tests {
    ...
    fun test_graduation_side_effects() {
        ...
        let proto_before;
        {
            ...
            proto_before         = bonding_curve::protocol_fees(&curve);
            ts::return_shared(curve);
        };
        ...
        let proto_after = bonding_curve::protocol_fees(&curve);
    ...
    fun test_claim_airdrop_fees_drains_bucket() {
        ...
        assert!(bonding_curve::airdrop_fees(&curve) == 0, 1701);
        destroy(airdrop);
        ts::return_to_sender(&s, admin_cap);
        ts::return_shared(curve);
        ts::end(s);
