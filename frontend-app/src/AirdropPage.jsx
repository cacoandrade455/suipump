            ...
            {[
              ...
              <div key={label} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < arr.length - 1 && <div className="w-px flex-1 bg-white/5 mt-1" />}
                </div>
                <div className="pb-3">
                  <div className="text-xs font-mono text-white/70 font-bold">{label}</div>
                  <div className="text-[11px] font-mono text-white/30 mt-0.5">{desc}</div>
                </div>
              </div>
            ))}
          </div>
