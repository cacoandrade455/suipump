...
export const translations = {
  en: {
    ...
    tradeHistory: 'TRADES',
    comments: 'COMMENTS',
    commentsGateHolders: 'holder-gated',
    commentsGateOpen: 'open to all',
    commentsPostInfo: '0.001 SUI per post · replies on-chain',
    ...
    airdropPointsLabel: 'AIRDROP POINTS',
    closedTrades: 'closed positions',
    rankWord: 'rank',
    youTag: 'YOU',
    networkTestnet: 'testnet',
    sessionPositions: 'SESSION POSITIONS',
    sessionParked: 'parked on your agent sessions',
    sessionTag: 'SESSION',
    readOnlyTag: 'READ-ONLY',
    sellAction: 'SELL',
    sellingAction: 'SELLING…',
    sessionSellOk: 'Position sold ✓',
    sessionSellFail: 'Sell failed',
    creatorFeesLabel: 'CREATOR FEES',
    claimAllAction: 'CLAIM ALL',
    claimingAction: 'CLAIMING…',
    claimableInFees: 'claimable in creator fees',
  ...
  zh: {
    ...
    tradeHistory: '交易记录',
    comments: '评论',
    commentsGateHolders: '持有者专属',
    commentsGateOpen: '对所有人开放',
    commentsPostInfo: '每条 0.001 SUI · 回复上链',
    ...
    realizedPnlLabel: '已实现盈亏',
    airdropPointsLabel: '空投积分',
    closedTrades: '已平仓',
    rankWord: '排名',
    youTag: '你',
    networkTestnet: '测试网',
    sessionPositions: '会话持仓',
    sessionParked: '寄存在您的代理会话中',
    sessionTag: '会话',
    readOnlyTag: '只读',
    sellAction: '卖出',
    sellingAction: '卖出中…',
    sessionSellOk: '已卖出 ✓',
    sessionSellFail: '卖出失败',
    creatorFeesLabel: '创作者费用',
    claimAllAction: '全部领取',
    claimingAction: '领取中…',
    claimableInFees: '可领取的创作者费用',
    statsTitle: '协议数据',
  ...
  pt: {
    ...
    commentsGateHolders: 'exclusivo para holders',
    commentsGateOpen: 'aberto a todos',
    commentsPostInfo: '0,001 SUI por post · respostas on-chain',
    ...
    realizedPnlLabel: 'PNL REALIZADO',
    airdropPointsLabel: 'PONTOS DE AIRDROP',
    closedTrades: 'posições fechadas',
    rankWord: 'rank',
    youTag: 'VOCÊ',
    networkTestnet: 'testnet',
    sessionPositions: 'POSIÇÕES DE SESSÃO',
    sessionParked: 'estacionadas nas suas sessões de agente',
    sessionTag: 'SESSÃO',
    readOnlyTag: 'SOMENTE LEITURA',
    sellAction: 'VENDER',
    sellingAction: 'VENDENDO…',
    sessionSellOk: 'Posição vendida ✓',
    sessionSellFail: 'Falha na venda',
    creatorFeesLabel: 'TAXAS DO CRIADOR',
    claimAllAction: 'RESGATAR TUDO',
    claimingAction: 'RESGATANDO…',
    claimableInFees: 'em taxas de criador para resgatar',
  ...
  ko: {
    ...
    tradeHistory: '거래 내역',
    comments: '댓글',
    commentsGateHolders: '홀더 전용',
    commentsGateOpen: '모두에게 공개',
    commentsPostInfo: '게시당 0.001 SUI · 답글 온체인',
    ...
    realizedPnlLabel: '실현 손익',
    airdropPointsLabel: '에어드롭 포인트',
    closedTrades: '청산된 포지션',
    rankWord: '순위',
    youTag: '나',
    networkTestnet: '테스트넷',
    sessionPositions: '세션 포지션',
    sessionParked: '에이전트 세션에 보관됨',
    sessionTag: '세션',
    readOnlyTag: '읽기 전용',
    sellAction: '매도',
    sellingAction: '매도 중…',
    sessionSellOk: '포지션 매도 완료 ✓',
    sessionSellFail: '매도 실패',
    creatorFeesLabel: '크리에이터 수수료',
    claimAllAction: '전체 청구',
    claimingAction: '청구 중…',
    claimableInFees: '청구 가능한 크리에이터 수수료',
    statsTitle: '프로토콜 통계',
  ...
  vi: {
    ...
    comments: 'BÌNH LUẬN',
    commentsGateHolders: 'chỉ người nắm giữ',
    commentsGateOpen: 'mở cho tất cả',
    commentsPostInfo: '0,001 SUI mỗi bài · trả lời on-chain',
    ...
    realizedPnlLabel: 'PNL ĐÃ THỰC HIỆN',
    airdropPointsLabel: 'ĐIỂM AIRDROP',
    closedTrades: 'vị thế đã đóng',
    rankWord: 'hạng',
    youTag: 'BẠN',
    networkTestnet: 'testnet',
    sessionPositions: 'VỊ THẾ PHIÊN',
    sessionParked: 'gửi trong các phiên đại lý của bạn',
    sessionTag: 'PHIÊN',
    readOnlyTag: 'CHỈ ĐỌC',
    sellAction: 'BÁN',
    sellingAction: 'ĐANG BÁN…',
    sessionSellOk: 'Đã bán vị thế ✓',
    sessionSellFail: 'Bán thất bại',
    creatorFeesLabel: 'PHÍ NGƯỜI TẠO',
    claimAllAction: 'NHẬN TẤT CẢ',
    claimingAction: 'ĐANG NHẬN…',
    claimableInFees: 'phí người tạo có thể nhận',
  ...
  ru: {
    ...
    commentsGateHolders: 'только для холдеров',
    commentsGateOpen: 'открыто для всех',
    commentsPostInfo: '0,001 SUI за пост · ответы в сети',
    ...
    realizedPnlLabel: 'РЕАЛИЗОВАННЫЙ PNL',
    airdropPointsLabel: 'ОЧКИ ЭЙРДРОПА',
    closedTrades: 'закрытых позиций',
    rankWord: 'ранг',
    youTag: 'ВЫ',
    networkTestnet: 'тестнет',
    sessionPositions: 'ПОЗИЦИИ СЕССИИ',
    sessionParked: 'размещены в ваших агентских сессиях',
    sessionTag: 'СЕССИЯ',
    readOnlyTag: 'ТОЛЬКО ЧТЕНИЕ',
    sellAction: 'ПРОДАТЬ',
    sellingAction: 'ПРОДАЖА…',
    sessionSellOk: 'Позиция продана ✓',
    sessionSellFail: 'Ошибка продажи',
    creatorFeesLabel: 'КОМИССИИ СОЗДАТЕЛЯ',
    claimAllAction: 'ЗАБРАТЬ ВСЁ',
    claimingAction: 'ПОЛУЧЕНИЕ…',
    claimableInFees: 'комиссий создателя к получению',
  ...
  es: {
    ...
    commentsGateHolders: 'solo holders',
    commentsGateOpen: 'abierto a todos',
    commentsPostInfo: '0,001 SUI por publicación · respuestas on-chain',
    ...
    realizedPnlLabel: 'PNL REALIZADO',
    airdropPointsLabel: 'PUNTOS DE AIRDROP',
    closedTrades: 'posiciones cerradas',
    rankWord: 'rango',
    youTag: 'TÚ',
    networkTestnet: 'testnet',
    sessionPositions: 'POSICIONES DE SESIÓN',
    sessionParked: 'estacionadas en tus sesiones de agente',
    sessionTag: 'SESIÓN',
    readOnlyTag: 'SOLO LECTURA',
    sellAction: 'VENDER',
    sellingAction: 'VENDIENDO…',
    sessionSellOk: 'Posición vendida ✓',
    sessionSellFail: 'Venta fallida',
    creatorFeesLabel: 'COMISIONES DEL CREADOR',
    claimAllAction: 'RECLAMAR TODO',
    claimingAction: 'RECLAMANDO…',
    claimableInFees: 'en comisiones del creador para reclamar',
