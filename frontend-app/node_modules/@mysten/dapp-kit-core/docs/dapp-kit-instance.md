...
The `createDAppKit` function is the foundation of your Sui app. It creates an instance that manages
...
- **networks:** A list of networks supported by the application (for example,
  `['mainnet', 'testnet']`)
