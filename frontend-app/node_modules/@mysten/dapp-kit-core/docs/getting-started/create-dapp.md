...
`@mysten/create-dapp` is a CLI tool that scaffolds a complete Sui app project with best practices
built in.
...
A basic React app that demonstrates wallet connection and fetching owned objects:
...
### Step 2: Configure the package ID
